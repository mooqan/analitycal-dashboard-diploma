...
const url_repository_hashmap_1 = require("./url.repository.hashmap");
...
exports.UrlModule = UrlModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [
            ...
            { provide: url_repository_1.UrlRepositoryTag, useClass: url_repository_hashmap_1.UrlRepositoryHashmap },
        ],
    })
], UrlModule);
